...
$server = '';
if(in_array("HTTP_ORIGIN", $_SERVER, TRUE)){
...
// $server3 = $_SERVER['HTTP_ORIGIN'];
$location = $server.$part2;
// print_r($part2);
// part2
...
$LIMIT_DAYS=30;
	...
	$dbs		= "frederic_frederic";	
	// print_r($path."/configuration/config.php");exit;
...
// 	if($parts['basename']=='new_login.php' && isset($_SESSION['allow_print'])){
// 		if($_SESSION['allow_print']=='accessInFileAllowed'){
// 			echo '<script>location.href="'.$path.'new_index.php";</script>';	
			
// 		}
		
// 	}
//    if($parts['basename'] != 'new_login.php' && $parts['basename'] != 'verify.php'){
	   
// 	   if(!isset($_SESSION['allow_print'])){
		   
// 		   // header("Location: ".$path."login.php");
		   
// 		   echo '<script>location.href="'.$path.'new_login.php";</script>';
// 		   exit;
