...
$server = $_SERVER['HTTP_ORIGIN'];
 ...
 $qry_vehtype  = "SELECT * FROM  vehicles";
        ...
        <div class="div-block-76">
          ...
          <ul role="list" class="headernav right">
            ...
            <li class="new-item-wrapper">
              <div class="navbarlinkwrapper-2">
                <div class="bg-2 navbarlinkicon"></div>
                <a href="../request-a-trip.html" aria-current="page" class="navbarlink main w-nav-link w--current">Book a Trip</a>
              </div>
            </li>
          </ul>
    ...
    <div id="tripform" class="tripsection wf-section">
      <div class="formcontainer w-container">
        <div class="iframecode  w-embed w-iframe w-script">
          <form id="contact-form" method="post" name="request_form" action="administrator/new.php" autocomplete="off">
            <div class="form-row">
                <div class="row">
                    <div class="col-sm-12 "
                ...
                <div class="row" style="margin-top:20px;margin-left:20px;">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group">
                            ...
                            <?php
                                foreach($vehiclepref as $veh){
                            ?>
                                <option value="<?php echo $veh['id'] ?>"><?php echo $veh['vname']?></option>
                             <?php
